          ...
          <div className="lg:mx-auto flex flex-row px-5 pb-24 text-center">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-4">
              <div className="lg:w-full w-full flex justify-center">
                <picture>
                  <source
                    srcSet="https://ik.imagekit.io/aq3ybtarw/landing/mobile-landing.webp?updatedAt=1680626119244"
                    type="image/webp"
                  />
                  <source
                    srcSet="https://ik.imagekit.io/aq3ybtarw/landing/mobile-landing.jpg?updatedAt=1680626119244"
                    type="image/jpeg"
                  />
                  <img
                    src="https://ik.imagekit.io/aq3ybtarw/landing/mobile-landing.jpg?updatedAt=1680626119244"
                    alt="hero-img"
