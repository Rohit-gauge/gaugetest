...
const Index = () => {
  ...
  return (
    <>
      <section className="privacy-main-wrap about-main-wrap  lg:pb-16">
        <div className="term-widget-container privacy-widget-container lg:pt-28 pt-16 container mx-auto  lg:px-28       px-4 lg:mb-6 ">
          <h2>Privacy Policy</h2>
          <p>Last updated: 02 February 2023</p>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              <strong>Lalita Ventures</strong>, D1075, 7th Floor, Tower D,
              Assetz 63 Degree East, Kodathi Village, Varthur Hobli, 1st Cross
              Rd.
            </li>{" "}
            <li>
            ...
            <li>
              <strong>Website</strong> refers to Lalita Ventures, accessible
              from{" "}
          ...
          <p>
            ...
            State, Province, Pincode/Zip code, City, Usage Data
          </p>
          <h3>Usage Data</h3>
          ...
          <div className="li-items">Comply with a legal obligation</div>{" "}
          ...
          <div className="li-items">Protect against legal liability</div>
